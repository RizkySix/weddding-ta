                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-header-form d-flex">
                                ...
                                <form action="/booking/unactive" method="GET">
                                ...
                                <table class="table-striped table">
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex gap-2" style="align-items:flex-start">
                                            ...
                                            <form method="POST" action="/booking/package/end/{{ $order->booking->id }}">
                                                @method('put')
                                                @csrf
                                                <button onclick="return window.confirm('Yakin konfirmasi selesai?') ? true : false" type="submit" class="btn btn-success mr-2">Konfirmasi</button>
                                            </form>
                                            </td>
                ...
                let item = `
                    ...
                    <div class="modal-body">
                        <ul class="list-group">
                            ...
                            <li class="list-group-item d-flex align-items-center gap-2">
                                <span class="material-icons mr-2 fw-bold">Status konfirmasi: </span> Belum konfirmasi selesai
                            </li>
                            ${expiredText}
                        </ul>
                    </div>
