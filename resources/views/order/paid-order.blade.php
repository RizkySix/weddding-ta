                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-header-form d-flex">
                                ...
                                <form action="/admin/order/paid" method="GET">
                ...
                let item = `
                    ...
                    <div class="modal-body">
                        <ul class="list-group">
                            ...
                            <li class="list-group-item d-flex align-items-center gap-2">
                                <span class="material-icons mr-2 fw-bold">Invoice: </span> <a href="/storage/${order.reference.invoice}.pdf" target="__blank">Klik untuk melihat invoice</a>
                            </li>
                            ${expiredText}
                        </ul>
                    </div>
